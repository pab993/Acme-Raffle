...
public class RaffleService {
	...
	public Collection<Raffle> findAllPublic() {
		Collection<Raffle> raffles = new ArrayList<Raffle>();
		raffles = raffleRepository.findAllPublic();
		return raffles;
	}
	...
	public void reconstruct(Raffle raffle, BindingResult binding) {
		checkPublicationDateAndDeadLine(raffle, binding);

	}

	private boolean checkPublicationDateAndDeadLine(Raffle raffle, BindingResult binding) {
		FieldError error;
		String[] codigos;
